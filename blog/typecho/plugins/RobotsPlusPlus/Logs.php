    ...
    <div class="body container">
        ...
        <div class="container typecho-page-main">
            <div class="col-mb-12 typecho-list">
                        ...
                        if (isset($_POST['do'])) {
                            ...
                            if ($do == 'delete') {
                                if (isset($_POST['lid'])) {
                                    ...
                                    Typecho_Response::redirect(Typecho_Common::url('extending.php?panel=RobotsPlusPlus%2FLogs.php', $options->adminUrl));
                                }else{
                ...
                <form class="operate-form" method="post" action="<?php $options->adminUrl('extending.php?panel=RobotsPlusPlus%2FLogs.php'); ?>">
