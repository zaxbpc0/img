...
<?php Content::outputCommentJS($this, $this->security); ?>
  ...
  <footer id="footer" class="app-footer" role="footer">
    <div class="wrapper bg-light">
      ...
      <a target="_blank" href="http://www.typecho.org">Typecho</a>&nbsp;|&nbsp;<a target="_blank" href="https://www.ihewro.com">handsome</a>
      </span>
        <span class="text-ellipsis">&copy;&nbsp;<?php echo date("Y");?> Copyright&nbsp;|&nbsp;<a target="_blank" href="https://eonegh.com/sitemap.html">SiteMap</a><?php
...
<?php $this->footer(); ?>
    ...
    <script type="text/javascript">
        window['LocalConst'] = {
            ...
            COMMENT_PLACEHOLDER: '<?php _me('博客开通了CDN加速，所以评论内容不会马上显示，提交后请一顿操作：Ctrl+F5，不谢！') ?>',
            SHOW_SETTING_BUTTON: '<?php echo in_array('showSettingsButton', $this->options->featuresetup) ? true :false; ?>',
