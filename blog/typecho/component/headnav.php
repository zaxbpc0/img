    ...
    <?php echo Content::selectNavbarCollapse() ?>
        ...
        <form id="searchform1" class="searchform navbar-form navbar-form-sm navbar-left shift" method="post"
          ...
          <div class="form-group">
            <div class="input-group searchrounded bg-white-pure box-shadow-wrap-normal">
              <input  autocomplete="off" id="search_input" type="search" name="s" class="transparent searchrounded form-control input-sm no-borders padder" required placeholder="<?php _me("输入关键词搜索…") ?>">
                <!--搜索提示-->
                <ul id="search_tips_drop" class="small-scroll-bar dropdown-menu hide" style="display: block;top: 30px; left: 0px;"></ul>
