  ...
  <?php if (@(!in_array('no-index',$this->options->sidebarSetting) && (!$this->is("post") && !$this->is("page")))||
      ...
      <section id="tag_cloud-2" class="widget widget_tag_cloud wrapper-md clear">
       <h5 class="widget-title m-t-none text-md"><?php _me("标签云") ?></h5>
          <div class="tags l-h-2x">
              ...
              <?php if($tags->have()): ?>
                  <?php while ($tags->next()): ?>
                  	  <span style="display: inline-block;background-color:rgb(<?php echo(rand(0,255)); ?>,<?php echo(rand(0,255)); ?>,<?php echo(rand(0,255)); ?>);margin-bottom:8px">
                      <a href="<?php $tags->permalink();?>" class="label badge bg-info-cloud" title="<?php $tags->name(); ?>" data-toggle="tooltip"><?php $tags->name(); ?></a>
                      </span>
                 <?php endwhile; ?>
              <?php endif; ?>
          </div>
    ...
    <?php else: ?>
          ...
          <div id="tag_toc_body">
              ...
              setting_body_panel"
                   aria-hidden="true">
                  <button class="border-radius-half-left btn btn-default no-shadow pos-abt " data-toggle-class=".tocify-mobile-panel=active">
