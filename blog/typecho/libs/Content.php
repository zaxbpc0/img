...
EOF;
        ...
        if (@in_array("snow", $options->featuresetup)) {
            ...
            $image = "https://img.okay.do/39de4eddb2b3ccb26dbcf6776c38568d_W300_H300_G1";
            $css .= <<<EOF
#aside .wrapper:hover {
...
EOF;
    ...
    {
    	$cars=array(
"3647136e0a0854ecf01071791f6d5c53_W1000_H375_G0",
"1f765f46d2e54d98297977241905ad59_W1000_H375_G0",
"df11fb27dd963ce07b40613739c7a39e_W800_H300_G0",
"f60426e059df025c5472a717953ac414_W1000_H375_G0",
"96588211810f28f38388d029fdcb1a43_W1000_H375_G0",
"acb614fe1bd3c75ba4b6db99c89d19f7_W1000_H375_G0",
"8b059f5e5245e9bd8384de6774be4def_W800_H300_G0");
        $options = mget();
        ...
        $random = 'https://img.okay.do/' . $cars[@$randomNum[$index]-1];
        $pattern = '/\<img.*?src\=\"(.*?)\"[^>]*>/i';
    ...
    public static function returnSharePostDiv($obj)
    {
        ...
        if (trim($headImg) == "") {//头图为空
            $headImg = 'https://img.okay.do/35217e7f4ea36aaef456d693f66e045a_W1000_H955_G0';
        }
...
<li><span class="post-icons"><i data-feather="eye"></i></span>{$viewNumString}</li>
...
class="db audio_info_area"><strong class="db audio_title">加载中……</strong><span class="audio_source text-muted">请稍等……
    ...
    public static function videoParseCallback($matches)
    {
        ...
        if (array_key_exists('pic', $attrs) && ($attrs['pic'] !== null || $attrs['pic'] !== "")) {
            ...
            $pic = 'https://img.okay.do/35217e7f4ea36aaef456d693f66e045a_W1000_H955_G0';
        }
